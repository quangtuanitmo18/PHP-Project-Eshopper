...
<body>
    ...
    <table style="">
        <tbody style="">
            ...
            <tr style="">
                <td style="">
                    <h1 style="font-size:17px;font-weight:bold;padding:0px 0px 5px;margin:0px;color:rgb(68,68,68)">Quý khách {{$customer->name}} đã đặt hàng tại Eshopper</h1>

                    {{-- <p style="margin:4px 0px;font-size:12px;line-height:18px;font-weight:normal;color:rgb(68,68,68)">Eshopper rất vui thông báo đơn hàng #{{$order_detail[0]->order->code_bill}} của quý khách đã được tiếp nhận và đang trong quá trình xử lý. Eshopper sẽ thông báo đến quý khách ngay khi hàng chuẩn bị được giao.</p> --}}
            ...
            <tr style="">
                ...
                ?>
                    ...
                    <td align="right" style="padding:5px 9px;"><span style="">{{request()->session()->get('fee_shipping_value')}}&nbsp;$</span></td>
                <?php } else {
                ?>
