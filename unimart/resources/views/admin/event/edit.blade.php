                ...
                <div class="card-body">
                    <form action="{{route("admin.event.update",$event->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="slug" id="slug" value="{{$event->slug}}">
                            @error('slug')
                            <small class="text-danger">{{$message}}</small>
                             @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="{{$k}}" value="{{$k}}" {{$event->status==$k?"checked":""}}>
