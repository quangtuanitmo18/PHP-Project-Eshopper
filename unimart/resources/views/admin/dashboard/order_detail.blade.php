    ...
    <table style="">
                        ...
                        <tbody style="">
                            ...
                            <tr style="">
                                <td colspan="2" style="padding:7px 9px 0px;border-top-width:0px;font-size:12px;color:rgb(68,68,68)" valign="top">
                                    <p style="font-size:12px;line-height:18px;font-weight:normal;color:rgb(68,68,68)"><strong style=" ">Phương thức thanh toán: </strong> {{$payment[$order->payment]}}</p>
                                    <p style="font-size:12px;line-height:18px;font-weight:normal;color:rgb(68,68,68)"><strong style=" ">Trạng thái thanh toán: </strong> {{$order_statuses[$order->status]}}<br>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="background-color:rgb(245,245,245)" width="100%">
                        <thead style="">
                            <tr style="">
                                ...
                                {{-- <th align="left" bgcolor="#02acea" style="padding:6px 9px;font-size:12px;line-height:14px;color:rgb(255,255,255)">Giảm giá</th> --}}
        ...
        <tfoot style="font-size:12px;line-height:18px;color:rgb(68,68,68)">
            ...
            <tr bgcolor="#eee" style="">
                <td align="right" colspan="4" style="padding:7px 9px;"><strong style=""><big style="">Tổng giá trị đơn hàng</big> </strong></td>
