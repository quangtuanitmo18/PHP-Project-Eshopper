...
<body style='overflow-x:hidden;'>
    ...
    <div class='box'>
        ...
        <h1 style="color:#ffffff">ESHOPPER ADMIN</h1>
                ...
                <div class='box-login'>
                    <div class='fieldset-body' id='login_form'>
                        ...
                        <label class='checkbox'>
                            ...
                            <label style='display:contents;' class="form-check-label" for="remember">
                                {{ __('Remember Me') }}
                            </label>

                        </label>

                        <button type="submit" id='' class="btn btn-primary" title="Get Started">
                            {{ __('Login') }}
                        </button>
